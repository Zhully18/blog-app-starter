...
const BlogDetails = () => {
  ...
  //get the first five blog post
  const firstFiveBlog = blog_list.slice(0, 5);

  const { id } = useParams();

  //get the blog based on id
    ...
    <div>
      ...
      <div className="comment">
        ...
        <form action="#">
          ...
          <div className="check">
            <input type="checkbox"  />
            <label htmlFor="#">Save my name and emailin thr browser</label>
          </div>
          <button>Send</button>
        </form>
      </div>
